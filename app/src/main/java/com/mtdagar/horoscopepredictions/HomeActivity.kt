...
class HomeActivity : AppCompatActivity(), HomeActivityInterface {
    ...
    private fun signList(): List<HoroItem> {
        ...
        for (i in 0 until 11) {
            ...
            when (i) {
                0 -> {
                    drawable = R.drawable.ic_aries_1
                    cardText = "Aries"
                }
                1 -> {
                    drawable = R.drawable.ic_virgo_1
                    cardText = "Virgo"
                }
                2 -> {
                    drawable = R.drawable.ic_taurus_1
                    cardText = "Taurus"
                }
                3 -> {
                    drawable = R.drawable.ic_cancer_1
                    cardText = "Cancer"
                }
                4 -> {
                    drawable = R.drawable.ic_gemini_1
                    cardText = "Gemini"
                }
                5 -> {
                    drawable = R.drawable.ic_libra_1
                    cardText = "Libra"
                }
                6 -> {
                    drawable = R.drawable.ic_sagittarius_1
                    cardText = "Sagittarius"
                }
                7 -> {
                    drawable = R.drawable.ic_aquarius_1
                    cardText = "Aquarius"
                }
                8 -> {
                    drawable = R.drawable.ic_pisces_1
                    cardText = "Pisces"
                }
                9 -> {
                    drawable = R.drawable.ic_capricornus_1
                    cardText = "Capricorn"
                }
                10 -> {
                    drawable = R.drawable.ic_scorpio_1
                    cardText = "Scorpio"
                }
                11 -> {
                    drawable = R.drawable.ic_leo_1
                    cardText = "Leo"
                }
            }
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            for(i in data){
                if(i.sign == sign) {
                    ...
                    //gadbad chiz dont call from background thread
...
interface HomeActivityInterface {
    fun popStory(sign: String, list: ArrayList<MyStory>, horoObject: Horo)
